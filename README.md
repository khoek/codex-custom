...
expected auto-dismissed UI and `0.158.0-k.4b1c0c30` snapshot output.
...
For example, stable `0.157.0` and commit `4b1c0c30dabd…` produce
`0.158.0-k.4b1c0c30`. Builds use that exact commit; installation never fetches
