...
expected auto-dismissed UI and `0.155.0-k.3abbf9fe` snapshot output.
...
For example, stable `0.154.0` and commit `3abbf9fe2c6b…` produce
`0.155.0-k.3abbf9fe`. Builds use that exact commit; installation never fetches
