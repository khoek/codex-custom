...
from upstream `main`. The custom version is `0.155.0-k.1715e550`. It carries a
...
expected auto-dismissed UI and `0.155.0-k.1715e550` snapshot output.
...
`0.155.0-k.1715e550`. Builds use that exact commit; installation never fetches
