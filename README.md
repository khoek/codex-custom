...
expected auto-dismissed UI and `0.157.0-k.53446f90` snapshot output.
...
For example, stable `0.156.1` and commit `53446f90a566…` produce
`0.157.0-k.53446f90`. Builds use that exact commit; installation never fetches
