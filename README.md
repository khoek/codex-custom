...
from upstream `main`. The custom version is `0.154.0-k.53719512`. It carries a
...
expected auto-dismissed UI and `0.154.0-k.53719512` snapshot output.
...
For example, stable `0.153.4` and commit `5371951292bb…` produce
`0.154.0-k.53719512`. Builds use that exact commit; installation never fetches
